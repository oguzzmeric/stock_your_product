        ...
        <div class=" vh-100 container border-top-0 bg-dark text-center text-lg-start my-5">
            <div class="row gx-lg-5 align-items-center mb-5   ">
                <div class="card-body px-4 py-5 px-md-5">
                    ...
                    <h2 class="text-white  mt-3 " > Welcome {{$user->name}}</h2>
                        ...
                        <table class="table" >
                            ...
                            @foreach($products as $product)
                                ...
                                <tr>
                                    ...
                                    <th class="text-white" >{{$product['number']}}</th>
                                    <th><a href="/edit-product/{{$product->id}}" class="  btn btn-light btn-block   text-center" >edit {{$product['name']}}</a></th>

                                    <th><button class="  btn btn-light btn-block   text-center" >Delete {{$product['name']}} </button></th>
